...
**Plans:** 1 plan
Plans:
- [x] 01-01-PLAN.md â€” Verify existing infrastructure against INFRA-01/02/03 requirements
...
**Plans:** 1 plan
Plans:
- [ ] 02-01-PLAN.md â€” Review existing content and close HERM-01 gaps (Ressourcenbedarf, Termine, Risiken)
